...
"""
Simclr official preprocessing script.
From Simclr's generator, we will call preprocessing
from here.

If this script is called as-is, it will preprocess 
the default flower dataset and return some images for 
debugging purposes.

Ref: https://colab.research.google.com/github/google-research/simclr/blob/master/tf2/colabs/finetuning.ipynb#scrollTo=HHSQuEwnCBKN
"""
